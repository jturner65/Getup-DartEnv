...
#all below added by JT
register(
    id='DartStandUp3d-v1',
    entry_point='gym.envs.dart:DartStandUp3dEnv',
    max_episode_steps=1000,
)

register(
    id='DartStandUpFullBody3d-v1',
    entry_point='gym.envs.dart:DartStandUpFullBody3dEnv',
    max_episode_steps=1000,
)
register(
    id='DartStandUp2d-v1',
    entry_point='gym.envs.dart:DartStandUp2dEnv',
    max_episode_steps=1000,
)
register(
    id='DartStandUp3dTorque-v1',
    entry_point='gym.envs.dart:DartStandUp3dTrqueEnv',
    max_episode_steps=1000,
)

#main environment for assist getup w/assist bot
register(
    id='DartStandUp3d_2Bot-v1',
    entry_point='gym.envs.dart:DartStandUp3dAssistEnv',
    max_episode_steps=1000,
    #kwargs={'args':{}} # put values in this dictionary to pass to env ctor
)

#environment for training with penalized constraint force 9/24/18
register(
    id='DartStandUp3d_2Bot-v2',
    entry_point='gym.envs.dart:DartStandUp3dAssistEnvCnstrnt', #standUp3d_2Bot_Cnstrnt
    max_episode_steps=1000,
)

#environment to test GAE paper results
register(
    id='DartStandUp3d_GAE-v1',
    entry_point='gym.envs.dart:DartStandUp3dGAE',
    max_episode_steps=1000,
)
#environment that will work with Akanksha's constraint policy
register(
    id='DartStandUp3d_2BotAKCnstrnt-v1',
    entry_point='gym.envs.dart:DartStandUp3dAssistEnv_AKCnstrnt',
    max_episode_steps=1000,
)

register(
    id='DartStandUp3dDemo-v1',
    entry_point='gym.envs.dart:DartStandUp3dDemo',
    max_episode_steps=1000,
)


#Akanksha's environment used to train her policy where constraint did all the work
register(
    id='DartKimaStandUp-v1',
    entry_point='gym.envs.dart:DartKimaStandUpEnv',
    max_episode_steps=1000,
)


##human joint limits TODO
