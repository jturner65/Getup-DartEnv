...
##        #thighs 
#        self.action_scale[[0,1,2,7,8,9]] = 30
##        #knees
#        self.action_scale[[3,10]] = 20
##        #abdomen and spine
#        self.action_scale[[14,15,16]] = 30
##        #shoulders/biceps
#        self.action_scale[[19,20,21,22,25,26,27,28]] = 15
        #causes bipedJT to explode but seems to need this
        #scale feet actions less
        #self.action_scale[[4,5,6,11,12,13]] = 20
        #scale thigh more (?)
        #self.action_scale[[0, 1, 2, 7, 8 ,9]] = 150
        #q and qdot == 2 * numDofs + 12, 2 w (force choice)
        obs_dim = 2 * numActDofs + 12 + 2#76
    ...
    def makeInitPose(self):
        ...
        tmpPose = [#laying flat with knees bent
            #root orientation
            0,0,1.57,
            #root location
            0,-0.827,0,
